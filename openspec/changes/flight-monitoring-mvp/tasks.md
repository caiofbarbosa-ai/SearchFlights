...
- [ ] 0.20 Run 3+ consecutive test executions — PARCIAL (06/09): flag Akamai CLEARED após ~1,5 dia de cadência controlada; ciclo agendado de 06/09 10h classificou GRU/VCP corretamente como CALENDAR_NOT_OPEN (sem BLOCKED). Estabilidade plena a confirmar nos próximos ciclos diários. Ver `poc/reports/smiles_poc_findings_2026-09-02.md` §3.1.3
